...
data_sample = PandasParameterType(pd.DataFrame({"DayOfWeek": pd.Series(["example_value"], dtype="object"), "Month": pd.Series(["example_value"], dtype="object"), "Temperature": pd.Series([0.0], dtype="float64"), "Rainfall": pd.Series([0.0], dtype="float64")}))
